<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:66:"F:\Mine\crmeb/application/admin\view\store\store_seckill\index.php";i:1527663960;s:57:"F:\Mine\crmeb/application/admin\view\public\container.php";i:1527663960;s:58:"F:\Mine\crmeb/application/admin\view\public\frame_head.php";i:1527663960;s:53:"F:\Mine\crmeb/application/admin\view\public\style.php";i:1527663960;s:58:"F:\Mine\crmeb/application/admin\view\public\inner_page.php";i:1527663960;s:60:"F:\Mine\crmeb/application/admin\view\public\frame_footer.php";i:1527663960;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                    ...
                    <div class="m-b m-l">
                        <form action="" class="form-inline">
                            ...
                            <select name="status" aria-controls="editable" class="form-control input-sm">
                                ...
                                <option value="1" <?php if($where['status'] == '1'): ?>selected="selected"<?php endif; ?>>上架</option>
                                <option value="0" <?php if($where['status'] == '0'): ?>selected="selected"<?php endif; ?>>下架</option>
                            </select>
                            <div class="input-group">
                                <input type="text" name="store_name" value="<?php echo $where['store_name']; ?>" placeholder="请输入活动标题" class="input-sm form-control" size="38"> <span class="input-group-btn">
