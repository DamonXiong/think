<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:68:"F:\Mine\crmeb/application/admin\view\wechat\wechat_message\index.php";i:1527663960;s:57:"F:\Mine\crmeb/application/admin\view\public\container.php";i:1527663960;s:58:"F:\Mine\crmeb/application/admin\view\public\frame_head.php";i:1527663960;s:53:"F:\Mine\crmeb/application/admin\view\public\style.php";i:1527663960;s:58:"F:\Mine\crmeb/application/admin\view\public\inner_page.php";i:1527663960;s:60:"F:\Mine\crmeb/application/admin\view\public\frame_footer.php";i:1527663960;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                    ...
                    <div class="m-b m-l">
                        <form action="" class="form-inline" id="form">
                            ...
                            <select name="type" aria-controls="editable" class="form-control input-sm">
                                ...
                                <?php if(is_array($mold) || $mold instanceof \think\Collection || $mold instanceof \think\Paginator): $k = 0; $__LIST__ = $mold;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                                 <option value="<?php echo $key; ?>" <?php if($where['type'] == $key): ?>selected="selected"<?php endif; ?>><?php echo $vo; ?></option>
                            ...
                            <div class="input-group">
                                <input type="text" name="nickname" value="<?php echo $where['nickname']; ?>" placeholder="请输入操作用户" class="input-sm form-control"> <span class="input-group-btn">
