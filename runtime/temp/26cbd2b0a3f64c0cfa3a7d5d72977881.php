<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:59:"F:\Mine\crmeb/application/admin\view\wechat\reply\index.php";i:1527663960;s:57:"F:\Mine\crmeb/application/admin\view\public\container.php";i:1527663960;s:58:"F:\Mine\crmeb/application/admin\view\public\frame_head.php";i:1527663960;s:53:"F:\Mine\crmeb/application/admin\view\public\style.php";i:1527663960;s:60:"F:\Mine\crmeb/application/admin\view\public\frame_footer.php";i:1527663960;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
        ...
        const vm = new Vue({
            ...
            methods: {
                submit: function(){
                    ...
                    $eb.axios.post("<?php echo Url('save',array('key'=>$key,'title'=>$title)); ?>",{key:this.key,status:this.status,data:this.dataGroup[this.type],type:this.type}).then(function(res){
