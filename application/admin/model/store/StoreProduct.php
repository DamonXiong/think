...
class StoreProduct extends ModelBasic
{
    ...
    public static function brokenLine($orderPrice)
    {
        ...
        if (isset($orderDays) && isset($sum)) {
            return ['c1' => $orderDays, 'c2' => $sum];
        }
    }
    ...
    public static function salesVolume($where, $color, $dat = '')
    {
        ...
        if (isset($stores) && isset($storeSum1)) {
            return ['c1' => $stores, 'c2' => $storeSum1, 'c3' => $total, 'c4' => $pric];
        }
    ...
    public static function profit($where, $color, $dat = '')
    {
        ...
        if (isset($stor) && isset($priceSum)) {
            return ['c1' => $stor, 'c2' => $priceSum, 'c3' => $total1, 'c4' => $pric];
        }
