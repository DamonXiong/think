...
<link href="__ADMIN_SYSTEM__/module/wechat/news/css/style.css" type="text/css" rel="stylesheet">
   ...
   <div class="col-sm-12">
       ...
       <div class="col-sm-2 panel panel-default news-left">
               ...
               <div class="panel-body news-box type-all" >
                   ...
                   <div class="news-item transition active news-image" style="margin-bottom: 20px;background-image:url('/public/admin/system/module/wechat/news/images/image.png')">

                   {/if}

                       <input type="hidden" name="new_id" value="{$news.id}" class="new-id">

<!--                       <span class="news-title del-news">x</span>-->

                   </div>

<!--                   <a href="javascript:void(0)" class="article-add transition"><i class="fa fa-plus"></i></a>-->

               </div>

<!--               <button type="button" class="btn btn-w-m btn-info" style="width: 100%">提交</button>-->
                               ...
                               <div class="form-control" style="height:auto">
                                   ...
                                   <div class="row nowrap">
                                       ...
                                       <div class="col-xs-3" style="width:160px">
                                           ...
                                           <div class="upload-image-box transition image_img" style="background-image:url('/public/admin/system/module/wechat/news/images/image.png')">
...
//                    $(".image_img").css('background-image',"url('http://cmseb.kycms.net/public/system/module/wechat/news/Images/image.png')");
...
//                    $eb.closeModalFrame(window.name);
    ...
    $('.article-add ').on('click',function (e) {
        ...
        var url = "/public/admin/system/module/wechat/news/images/image.png";
