                ...
                <div class="table-responsive ibox-content" style="padding-right: 0;padding-left: 0;overflow:visible">
                    <div class="row">
                        ...
                        <div class="col-sm-12 m-b-sm">
                            <span>售出商品：<strong class="text-danger m-sm">{$price.total_num}</strong></span>
                            <span>订单数量：<strong class="text-danger m-sm">{$list_num.total}</strong></span>
                            <span>订单金额：<strong class="text-danger m-sm">￥{$price.pay_price}</strong></span>
                            <span>退款金额：<strong class="text-danger m-sm">￥{$price.refund_price}</strong></span>
                        </div>
                            ...
                            <td class="text-right">
                                <span class="input-group-btn js-group-btn" style="min-width: 106px;">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a  href="javascript:void(0);" onclick="$eb.createModalFrame('去送货','{:Url('delivery',array('id'=>$vo['id']))}')">
