...
class StoreBargain extends ModelBasic
{
     ...
     * @return array
     */
    public static function getBargainTerm($bargainId = 0,$field = 'id,product_id,bargain_num,unit_name,image,title,price,min_price,image,description,start_time,stop_time'){
        if(!$bargainId) return [];
        $model = self::validWhere();
